...
test('view document', async ({ page }) => {
  ...
  await page.getByTestId('demo-app-select-file-btn').click();
  ...
  await page
    .getByTestId(`toolbar-item-plugin-${PdfApplicatinPluginKey.Metadata}`)
    .click();
  await page.getByTestId('pdf__plugin__metadata__content');
  await page.getByTestId('pdf__ui__dialog__close__btn').click();

  await page
    .getByTestId(`toolbar-item-plugin-${PdfApplicatinPluginKey.Bookmarks}`)
    .click();
  await page.getByTestId('pdf__plugin__bookmarks__content');
  await page.getByTestId('pdf__ui__dialog__close__btn').click();

  await page
    .getByTestId(`toolbar-item-plugin-${PdfApplicatinPluginKey.Thumbnails}`)
    .click();
  await page.getByTestId('pdf__plugin__thumbnails__content');
  await page.getByTestId('pdf__ui__dialog__close__btn').click();

  await page
    .getByTestId(`toolbar-item-plugin-${PdfApplicatinPluginKey.Attachments}`)
    .click();
  await page.getByTestId('pdf__plugin__attachments__content');
  await page.getByTestId('pdf__ui__dialog__close__btn').click();

  await page
    .getByTestId(`toolbar-item-plugin-${PdfApplicatinPluginKey.Signatures}`)
    .click();
